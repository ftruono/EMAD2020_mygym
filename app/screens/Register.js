...
export default function Register(props) {
    ...
    handleChange = handleChange.bind(Register);
            ...
            case 'form_pt':
                return (
                    <View name="form_pt">
                        ...
                        <TouchableOpacity style={[styles.appButtonContainer, { marginTop: 50, width: 200 }]} onPress={validateFormPT}>
                            <Text style={styles.appButtonText}>Registrati</Text>
                        </TouchableOpacity>
                    </View>);
            case 'form_nutri':
    ...
    function handleChange(event) {
        setSelectedValue(event.target.onChangeItem);
    }
